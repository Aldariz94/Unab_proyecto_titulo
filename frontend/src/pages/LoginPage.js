        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-zinc-900">
            <div className="w-full max-w-md">
                ...
                <form 
                    ...
                    className="bg-white shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4 dark:bg-zinc-800"
                >
                    <div className="flex justify-center mb-6">
                        <img src="/images/logo_colegio.png" alt="Logo Colegio Inmaculada de Lourdes" style={{ height: '180px' }} />
                    </div>
